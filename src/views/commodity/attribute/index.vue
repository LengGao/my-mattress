...
<script>
import { all,ban,deleter } from '@/api/commodity/attribute'
import { vueDebounce } from '@/utils/index'
// 门店管理
let tableConfig = [
  {label: '属性编号',key: 'id', type: ''},
  {label: '属性名称',key: 'name',type: ''},
  {label: '显示名称',key: 'display_name',type: ''},
...
export default {
  ...
  methods: {
    ...
    handlerPageChange (type,id) {
      ...
      this.$router.push({ path: 'attribute/modify', query: {type: type, id: id || ''} })
    },
    getSearchFeild() {
