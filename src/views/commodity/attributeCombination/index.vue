...
<script>
import { all,ban,deleter,allTypes } from '@/api/commodity/attributeCombination'
...
let tableConfig = [
  ...
  {label: '单价',key: 'actual_price',type: ''},
...
export default {
  ...
  methods: {
    ...
    handlerPageChange (type,id) {
      ...
      this.$router.push({ path: 'attributeCombination/modify', query: {type: type, id: id || ''} })
    },
    getSearchFeild() {
